<template lang="">
  ...
  >
    ...
    <input 
      ...
      @input='$event => this.inputSearch($event)'
    >
    <div class="search_buttons">
      <button class="clear" @click="this.clearSearch"  v-show="this.searchValue.length">
        <search-clear/>
      </button>
...
export default {
  ...
  computed: {
    state() {
      return (this.searchValue.length) ? "input" : "default"
    }
  }
}
</script>
